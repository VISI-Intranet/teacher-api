...
import Alpakka.Handlers.AddHandler.RecieveHandler
...
object RecieveMessageAlpakka {
  ...
  def subscription(modelMQ: RabbitMQModel, connectionProvider: AmqpConnectionProvider ,handler: (String, String) => Unit = RecieveHandler.handler, messageType: String = "Event")
